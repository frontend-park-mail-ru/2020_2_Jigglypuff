;(function() {
    const x=Function('return this')(); if (!x.fest)x.fest={}; x.fest['static/components/Profile/Profile.tmpl']=function(__fest_context) {
        ...
        } const profile=__fest_context; __fest_buf+=('<style>.avatar {\n    display: inline-block;\n    width: 50%;\n    border: 3px solid red; \/* Белая рамка *\/\n    border-radius: 10px; \/* Радиус скругления *\/\n    margin-bottom: 4px;\n    color: white;\n}\n\n.avatar-img {\n    width: 100%;\n    height: 100%;\n    \/*padding-top: 10px;*\/\n}\n\n.border {\n    border: 3px solid red; \/* Белая рамка *\/\n    border-radius: 10px; \/* Радиус скругления *\/\n}\n\n.border-padding {\n    padding: 10px;\n}\n.border-margin {\n    margin: 4px;\n}\n\n.height-auto {\n    height: auto;\n}\n\n.flex-column {\n    flex-direction: column;\n}</style><div class="d-flex w-1170 align-center"><div class="avatar border-margin"><img class="avatar-img" alt="" src="'); try {
            __fest_buf+=(__fest_escapeHTML(profile.AvatarPath));
        } catch (e) {
            __fest_log_error(e.message + '9');
        }__fest_buf+=('"/></div><div><div class="border border-padding border-margin"><div class="d-flex flex-row"><div class="d-flex flex-column border-padding"><h2 align="left">Фамилия:</h2><h2 align="left">Имя:</h2></div><div class="d-flex flex-column border-padding"><h2 align="left">'); try {
            __fest_buf+=(__fest_escapeHTML(profile.Name));
        } catch (e) {
            __fest_log_error(e.message + '27');
        }__fest_buf+=('</h2><h2 align="left">'); try {
            __fest_buf+=(__fest_escapeHTML(profile.Surname));
        } catch (e) {
            __fest_log_error(e.message + '30');
        }__fest_buf+=('</h2></div></div><button id="edit">Редактировать</button></div></div></div>'); __fest_to=__fest_chunks.length; if (__fest_to) {
