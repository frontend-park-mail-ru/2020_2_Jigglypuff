;(function() {
    const x=Function('return this')(); if (!x.fest)x.fest={}; x.fest['static/components/SignUp/SignUp.tmpl']=function(__fest_context) {
        ...
        }__fest_buf+=('<form class="wrapper__form" id="signUpForm"><h2 align="center">Регистрация</h2><main><input name="login" type="login" placeholder="Логин"/><input name="password" type="password" placeholder="Пароль"/><button>Зарегистрироваться</button></main></form>'); __fest_to=__fest_chunks.length; if (__fest_to) {
