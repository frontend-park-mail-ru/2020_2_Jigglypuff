;(function() {
    const x=Function('return this')(); if (!x.fest)x.fest={}; x.fest['static/components/EditProfile/EditProfile.tmpl']=function(__fest_context) {
        ...
        } const profile=__fest_context; __fest_buf+=('<style>.avatar-card {\n    display: inline-block;\n    width: 50%;\n    border: 3px solid red; \/* Белая рамка *\/\n    border-radius: 10px; \/* Радиус скругления *\/\n    margin-bottom: 4px;\n    color: white;\n}\n\n.avatar-poster {\n    width: 100%;\n    height: 100%;\n    \/*padding-top: 10px;*\/\n}</style><div class="d-flex w-1170 h-100 align-center"><div class="avatar-card"><img class="avatar-poster" alt="" src=""/></div><div class="ml-4"><form method="POST" class="wrapper__form" id="profileSettingsForm"><h2 class="align-center">Редактирование</h2><main><input name="name" type="text" placeholder="Имя"/><input name="surname" type="text" placeholder="Фамилия"/><input type="file" name="avatar" accept="image\/*" placeholder="Аватар"/><button type="submit">Принять</button></main></form></div></div>'); __fest_to=__fest_chunks.length; if (__fest_to) {
