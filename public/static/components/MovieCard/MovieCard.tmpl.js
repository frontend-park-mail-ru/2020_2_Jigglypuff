;(function() {
    const x=Function('return this')(); if (!x.fest)x.fest={}; x.fest['static/components/MovieCard/MovieCard.tmpl']=function(__fest_context) {
        ...
        }__fest_buf+=('</p></div>'); __fest_to=__fest_chunks.length; if (__fest_to) {
